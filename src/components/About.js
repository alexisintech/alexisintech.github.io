              ...
              <div className="d-flex flex-column align-items-center text-center">
                ...
                {previously && (
                  <p>
                    ...
                    Herpetology + Invasive Species research while also serving
                    her peers as both a Biology and Writing Teaching Assistant.
                    After receiving a B.S. in both Biology and Chemistry, she
                    was privileged to help her community as a veterinary
                    technician in gold standard animal hospitals for over 2.5
                    years.
                  </p>
                )}
              </div>
          ...
          <Col xs={12} md={4}>
            <CustomOverlayTrigger>
              <div className="d-flex flex-column align-items-center text-center">
                ...
                {mantra && (
                  <p>
                    After surviving an adverse childhood, Alexis spends every
                    day creating a life to be proud of. Through reading,
                    journaling, and spirituality, she dedicates herself to
                    nurturing meaningful relationships, finding balance between
          ...
          <Col xs={12} md={4}>
            <CustomOverlayTrigger>
              <div className="d-flex flex-column align-items-center text-center">
                ...
                {community && (
                  <p>
                    Peace, Love, Unity, Respect. Alexis is incredibly proud to
                    be a Community Relations Administrator of Space Fam, a
                    community of 400+ ravers in Miami, FL. Alexis manages the
                    community chat and discord server, organizes events and info
                    sessions, and advocates for rave safety through drug
                    education and awareness. She loves connecting electronic
                    dance lovers with their favourite DJ's in the music
                    industry.
                  </p>
                )}
              </div>
